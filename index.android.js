...
(function(exports) {
  ...
  var header = function (nav) {
      ...
      var logoStyles = ReactNative_Styles.styles([ ReactNative_Styles.padding(15) ]);
...
(function(exports) {
  ...
  var selectStyles = {
      imageStyles: ReactNative_Styles.styles([ ReactNative_Styles.resizeMode(ReactNative_Styles.contain), ReactNative_Styles.height(300), ReactNative_Styles.width(300) ]), 
      placeholderStyles: ReactNative_Styles.styles(placeholderStyles), 
      touchableStyles: ReactNative_Styles.styles([  ])
  };
  ...
  var editStyles = {
      imageStyles: ReactNative_Styles.styles([ ReactNative_Styles.resizeMode(ReactNative_Styles.cover), ReactNative_Styles.flex(1) ]), 
...
(function(exports) {
  ...
  var render = function (d) {
      return function (nav) {
          var next = Data_Function_Eff.mkEffFn1(function (v) {
              return Routes.replace(nav)(Routes.CalendarView.create(Dates.nextWeekStart(d)));
          });
          var currentText = Dates.showDate(d);
  ...
  var render = function (v) {
      return function (nav) {
          var mealTypePhrase = function (v1) {
              ...
              throw new Error("Failed pattern match at Screens.MealView line 46, column 10 - line 47, column 10: " + [ v1.constructor.name ]);
          };
          return ReactNative_Components_View.view_([ ReactNative_Components_View.view_([ Components_Header.header(nav), Components_Container.container([ ReactNative_Components_Text.text_(v.name) ]), React.createElement(mealDetail(v)(nav))(Data_Unit.unit)([  ]) ]) ]);
      };
  };
...
(function(exports) {
  ...
  var render = function (w) {
      return function (nav) {
          ...
          var currentText = Meals_Slots.showWeekNo(w);
          var back = Data_Function_Eff.mkEffFn1(function (v) {
...
(function(exports) {
  ...
  var setMeal = function (v) {
      return function (v1) {
          return function (v2) {
              ...
              throw new Error("Failed pattern match at Screens.SelectMeal line 104, column 1 - line 104, column 32: " + [ v.constructor.name, v1.constructor.name, v2.constructor.name ]);
          };
      };
  };
  var mealDetailsContainer = function (v) {
      return function (v1) {
          if (v1 instanceof Data_Maybe.Just) {
              return ReactNative_Components_View.view_([ Components_MealDetails.mealDetails(v1.value0)(Components_MealDetails.selectStyles), ReactNative_Components_Button["button'"](function (v2) {
                  var $26 = {};
                  for (var $27 in v2) {
                  ...
                  $26.onPress = Data_Function_Eff.mkEffFn1(function (v3) {
                      return ReactNative_Components_Navigator.push(v)(new Routes.MealView(v1.value0));
                  });
                  return $26;
              })("Edit meal details") ]);
          };
          ...
          throw new Error("Failed pattern match at Screens.SelectMeal line 49, column 1 - line 52, column 4: " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
          ...
          return function (meals) {
              var r = function (ctx) {
                  var selectedMeal = function (mabes) {
                      ...
                      throw new Error("Failed pattern match at Screens.SelectMeal line 84, column 40 - line 86, column 45: " + [ mabes.constructor.name ]);
                  };
                  ...
                  return function __do() {
                      ...
                      return ReactNative_Components_View.view_([ ReactNative_Components_Text.text_("Choose a meal to be served at this mealtime.  If the meal is not in the list of saved meals below, add a new meal by pressing the \"New meal\" button."), ReactNative_Components_Button["button'"](function (v1) {
                          ...
                          $36.onPress = Data_Function_Eff.mkEffFn1(function (v2) {
                              return ReactNative_Components_Navigator.push(nav)(new Routes.MealView(Meals_Meals.blankMeal));
                          });
                          return $36;
                      })("New meal"), Components_Picker.picker(Components_Picker.intPicker)(selectedMeal(v))(handler)(options(meals)), mealDetailsContainer(nav)(v), ReactNative_Components_View.view(buttonContainerStyles)([ ReactNative_Components_View.view(buttonViewStyles)([ ReactNative_Components_Button["button'"](function (v1) {
                          var $40 = {};
                          for (var $41 in v1) {
                              if ({}.hasOwnProperty.call(v1, $41)) {
                                  $40[$41] = v1[$41];
                          ...
                          $40.color = ReactNative_PropTypes_Color.gray;
                          $40.onPress = Data_Function_Eff.mkEffFn1(function (v2) {
                              return ReactNative_Components_Navigator.pop(nav);
                          });
                          return $40;
                      })("Cancel") ]), ReactNative_Components_View.view(buttonViewStyles)([ ReactNative_Components_Button["button'"](function (v1) {
                          ...
                          $44.disabled = Data_Maybe.isNothing(v);
                          $44.color = ReactNative_PropTypes_Color.rgbi(14911509);
                          return $44;
                      })("Save") ]) ]) ]);
                  };
              };
              return React.createClass((function () {
                  var $49 = React.spec(Data_Maybe.Nothing.value)(r);
                  var $47 = {};
                  for (var $48 in $49) {
                      if ({}.hasOwnProperty.call($49, $48)) {
                          $47[$48] = $49[$48];
                      };
                  };
                  $47.componentDidMount = loadMeal(slot);
                  return $47;
              })());
          };
      };
  ...
  var selectMeal = function (nav) {
      return function (slot) {
          ...
          return React.createClass((function () {
              ...
              var $51 = {};
              for (var $52 in $53) {
                  if ({}.hasOwnProperty.call($53, $52)) {
                      $51[$52] = $53[$52];
                  };
              };
              $51.componentDidMount = loadMeals;
              return $51;
          })());
      };
  };
  var render = function (v) {
      return function (nav) {
          ...
          return ReactNative_Components_View.view_([ Components_Header.header(nav), Components_Container.container([ ReactNative_Components_Text.text_(Meals_Slots.showSlotDate(v.date)), ReactNative_Components_Text.text_("Lunch: " + mealTypePhrase(v.mealType)), React.createElement(selectMeal(nav)(v))(Data_Unit.unit)([  ]) ]) ]);
      };
  };
  exports["render"] = render;
